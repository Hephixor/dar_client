        ...
        <div class=\"col-sm-4\">
         <div class=\"item\">
           <p class="item-description" style="margin-top:25px">
            <form enctype="multipart/form-data" action="retArtiste.php" method="post">
              <p class="field"><label>Nom Artiste</label><input name="nomArtiste" required="required" placeholder="Nom de l'artiste" type="text"/></p>
              <p class="field"><label>Site Web</label><input name="site" placeholder="Site web de l'artiste " type="text" /></p>
              <p class="field"><label>Style</label><input name="style" placeholder="Style musical artiste" type="text" /></i></p>
              <p class="field"><label>Informations</label><textarea name="informations" value="" required="required" placeholder="Chronique" rows="10" cols="80">
