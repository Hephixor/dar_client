...
<section id="main-content" class="main-content blog-post-singgle-page">
  <div class="container">
    <div class="row">
      <div class="col-sm-8">
       <center> <h1>Ajouter une news</h1> </center>
       <br/><br/>

       <form enctype="multipart/form-data" action="retNews.php" method="post">
        <br/><p class="field"><label>Titre de la news : </label>
        <input type="text" name="titre" placeholder="Titre de la news"/></p>
        <p class="field"><label>Image : </label>
          <input type="hidden" name="MAX_FILE_SIZE" value="2500000" />
          <input type="file" name="fic"/></p>
          <p class="field"><label>Vidéo : </label>
            <input type="text" name="lien" placeholder="Lien vidéo Youtube"/></p>
            <p class="field"><label> News : </label>  
              <textarea name="contenu" value="" required="required" placeholder="" rows="10" cols="80">
                Bienvenue dans l'éditeur de news !
              </textarea>
              <script>
            ...
            <br/>
            <center> 
<!-- <a href="#" class="buttonNice"><span><input name="submit" type="submit" value="AJOUTER" style="background: transparent none ; border: none;"/></span></a>
<a href="#" class="buttonFancy"><span><input name="reset" type="reset"  value="ANNULER" style="background: transparent none ; border: none;"  /></span></a>
