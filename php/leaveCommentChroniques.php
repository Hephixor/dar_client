...
echo"<div id=\"leave-comment\" class=\"clearfix leave-comment\">
	...
	<div id=\"respond\">
		<form action=\"./php/addCommentChroniques.php\" method=\"post\" id=\"commentform\" class=\"commentform\">
			<input id=\"auteur\" class=\"name\" name=\"auteur\" type=\"hidden\" value=\"".$_SESSION['id']."\" required>
			<input id=\"idChronique\" class=\"name\" name=\"idChronique\" type=\"hidden\" value=\"".$_GET['idChronique']."\" required>
