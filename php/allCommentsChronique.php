...
if ( isset($_GET['idChronique']) ){
	...
	echo " 
	<div id=\"comments\" class=\"comments\" style=\"padding-bottom:0px;\">
	...
	if(!$colnbc[0]){
		...
		$nbc= $colnbc[0];
		echo"<h3 class=\"comment-title\"><span class=\"title-icon\"><i class='fa fa-comments'></i></span>".$nbc." Commentaire"; if($nbc>1){echo's';}
		echo"</h3>
...
{  
	...
	<p>".$col[1]." </p>	<!-- <a class=\"btn\" href=\"#\"><span class=\"btn-icon\"><i class=\"fa fa-reply-all\"></i></span>Reply</a> -->
	</div>
