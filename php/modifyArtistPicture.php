...
function redirect($url)
{
    ...
    {    
       ...
       if (!$res) {
            ...
            $req = "REPLACE INTO profileartistspictures (idArtiste,descImage, nomImage, tailleImage, typeImage, imageData) VALUES (".$idArtiste.",'',".
                                "'" . $nomImage . "', " .
                                "'" . $tailleImage . "', " .
                                "'" . $typeImage . "', " .
        ...
        if (mysqli_query($cnx, $req)) {
         ...
         redirect('..\artiste.php?idArtiste='.$idArtiste);
     }
