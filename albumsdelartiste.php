...
if ( isset($_GET['idArtiste']) ){
  ...
  WHERE a.idArtiste = ar.idArtiste AND l.idLabel = a.idLabel AND a.idArtiste=".$id;
...
<section id=\"latest-post\" class=\"latest-post\" style=\"padding-top: 40px;\">
  <div class=\"container\"  style=\"width:80%\">
    <div class=\"post-area\" style=\"width:100%\">
      <div class=\"post-area-top text-center\">
        <h2 class=\"post-area-title\">Albums de ".$nomArtiste."</h2>
 ...
 require_once("./php/loadAlbumsArtiste.php");
